#pip install werkzeug passlib cryptography    -- instalamos las tres librerias que necesitaremos
...
#verifica que la contraseña cifrada fue originada con el texto 
